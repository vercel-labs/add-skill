export type AgentType = 'amp' | 'antigravity' | 'claude-code' | 'clawdbot' | 'cline' | 'codex' | 'cursor' | 'droid' | 'gemini-cli' | 'github-copilot' | 'goose' | 'kilo' | 'kiro-cli' | 'opencode' | 'roo' | 'trae' | 'windsurf' | 'neovate';
